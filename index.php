 ...
 <div class="navbar navbar-fixed-top">
   <div class="navbar-inner">
     <div class="container" style="width: auto;">
        ...
        <a class="brand" href="#">&nbsp;&nbsp;&nbsp;&nbsp;Green Trails&nbsp;&nbsp;&nbsp;&nbsp;</a>
        <div class="nav-collapse">
          <ul class="nav">
            <li class="active"><a href="#">Home</a></li>
		 <li><a href="#myuploads">My Upoads</a></li>
            <li><a href="selectloc.php">Upload a Photo</a></li>
...
<iframe scrolling='no' frameborder='0' width="100%" id='myifrmid' src='maptag.php'
         onload='javascript:myiresizeIframe(this);'>
</iframe>
  </div> <!-- #container -->
<script language="javascript" type="text/javascript">
...
<option value="people">Mountain Cleaniness</option><option value="wild-life">Maintainence of rivers</option><option value="objects">Personal Maintenence</option><option value="None">Uncatagorized</option>
