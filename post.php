...
<header class="jumbotron subhead" id="overview">
  <div class="row">
    <div class="span6">
      <p class="lead"><?php echo (randomArrayVar($greeting));?>
	<h1> <?php echo $_SESSION['username']?></h1></p>
    </div>
...
<?php
    ...
    mysql_select_db("ih",$con);
    if(isset($_POST['post_pos']))
	{
		$post=$_POST['makepost'];
...
<section id="post">
  ...
  <div class="row">
    <div class="span10 offset1">
      ...
      <form class="form-horizontal well" method="post" action="post.php" enctype="multipart/form-data">
        <fieldset>
          <legend>Post you experience</legend>


          <div class="control-group">
		<textarea rows="5" cols="100" name="makepost"> </textarea>	<br><br>
		<input type="hidden" name="post_pos" />
