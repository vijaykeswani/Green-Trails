...
<title>Select the location of your photograph</title>
...
function showResults(results, status) {
 ...
 var latlongstring = results[0].geometry.location.toString();
	document.getElementById("query").value=latlongstring;
...
function getAddressComponentsHtml(components) {
  ...
  for (var i = 0; i < components.length; i++) {    
    html += tr("Name", components[i].long_name);
